# 🛡️ CAA: Trinity Capped Architecture
...
## 📖 Overview
This repository contains the source code for the **"Trinity Capped"** model, which ranked in the **Top ??** (out of 280+ teams) in a quantitative finance data challenge (2025).
...
Instead of relying on raw data, we engineered domain-specific features:
